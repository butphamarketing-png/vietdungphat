...
function keepHousePhoto(src = "") {
  ...
  if (url.startsWith("/villas/") || url.startsWith("/interior/") || url.startsWith("/media/") || url.startsWith("/bai/") || url.startsWith("/mau-nha/")) return true;
  if (/ytimg\.com|youtube\.com/i.test(url)) return true;
